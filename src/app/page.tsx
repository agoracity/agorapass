...
function Page() {
  ...
  return (
    <div className='flex flex-col w-full p-4'>
      <div className='flex flex-col items-center mb-8 mx-4 md:mx-8 lg:mx-16 xl:mx-32 text-center'>
        <p className='text-lg max-w-3xl'>
          AgoraPass is a platform for decentralized community self-curation kickstarted by Zuzalu members.
          Explore user profiles, search for members, and help build a trust network by vouching for each other.
        </p>
